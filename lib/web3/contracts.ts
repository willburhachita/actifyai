import tokenArtifact from "@/contracts/artifacts/contracts/ActifyToken.sol/ActifyToken.json";
import escrowArtifact from "@/contracts/artifacts/contracts/ActifyEscrow.sol/ActifyEscrow.json";

export const FREE_STARTER_ACT = 1000;
export const TOKEN_PROGRESS_MAX = 1000;
...
// Use the latest compiled Hardhat artifacts as the deployment source of truth.
export const TOKEN_BYTECODE = tokenArtifact.bytecode as string;
export const ESCROW_BYTECODE = escrowArtifact.bytecode as string;
