...
export interface ActifyTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FAUCET_AMOUNT"
      | "allowance"
...
export interface ActifyToken extends BaseContract {
  connect(runner?: ContractRunner | null): ActifyToken;
  waitForDeployment(): Promise<this>;

  interface: ActifyTokenInterface;
